...
const Collection1 = () => {
  ...
  function createData(id, Donorname, Foodtype, Quantity, Date) {
    return { id, Donorname, Foodtype, Quantity, Date };
  }
      ...
      <Table sx={{ minWidth: 650}} aria-label="simple table">
        <TableHead>
          <TableRow sx={{bgcolor:"#D2E7FA"}}>
            ...
            <TableCell align="right" style={{marginInlineStart:"20px"}}>Donor Name</TableCell>
