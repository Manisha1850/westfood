...
const Donor = () => {
  ...
  function createData(id, Name, Email, Phone, Address, Hotel) {
    return { id, Name, Email, Phone, Address, Hotel };
  }
      ...
      <Table sx={{ minWidth: 650}} aria-label="simple table">
        <TableHead>
          <TableRow sx={{bgcolor:"#D2E7FA"}}>
            ...
            <TableCell align="right" style={{marginInlineStart:"20px"}}>Name</TableCell>
